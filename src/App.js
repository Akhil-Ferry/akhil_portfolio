// Terminal-themed portfolio website for Akhil Pulipaka
  ...
  return (
    <div>
      <header className="header">
        ...
        <div className="links">
          <a href="https://www.linkedin.com/in/akhil-pulipaka-6901a7263/" target="_blank" rel="noopener noreferrer">LinkedIn  </a>
          <a href="https://github.com/Akhil-Ferry" target="_blank" rel="noopener noreferrer">GitHub  </a>
          <a href="https://leetcode.com/u/pulipakaakhil/" target="_blank" rel="noopener noreferrer">Leetcode  </a>
        </div>
      ...
      <main>
        <section className="about">
          <h2>About Me</h2>
          <p>I am Undergraduate Computer Science student at SR University(2021-2025), Warangal, India. Passionate about software development and problem-solving.</p>
        </section>

        <section className="skills">
          <h2>Skills</h2>
          <div className="skills-logos">
            {['C', 'C++', 'Java', 'Python', 'HTML', 'CSS', 'JavaScript','MySQL' ].map((skill) => (
        ...
        <section className="projects">
          ...
          <ul>
            ...
            <li>
              ...
              A system to track and manage student data using Flask and MySQL.
            </li>
            <li>
              <strong>Bus Reservation System:</strong> 
              A ticketing system implemented in C.
            </li>
          </ul>
        </section>
        ...
        <section className="education">
          <h2>Education</h2>
          <ul>
            <li>(UG)SR University, Warangal, India (B.Tech, Computer Science, 2021-2025)</li>
